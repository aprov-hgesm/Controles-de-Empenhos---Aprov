          ...
          <div className="mt-7 flex items-start gap-3 rounded-2xl border border-emerald-300/10 bg-emerald-400/[0.05] p-4">
            ...
            <div>
              <p className="text-sm font-extrabold text-emerald-100">
                Fundação isolada ativa
              </p>
              <p className="mt-1 text-xs leading-5 text-slate-400">
                Esta área está habilitada somente para a conta fundadora. Nenhuma
                função operacional de estoque foi iniciada nesta fase.
              </p>
            </div>
          </div>
        </header>

        <section className="mt-6 rounded-3xl border border-white/[0.07] bg-white/[0.025] p-6 sm:p-8">
