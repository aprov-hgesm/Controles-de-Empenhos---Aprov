...
const cleanHook = hook.replace(/[ \t]+$/gm, '');
const hookSf = ts.createSourceFile(OUT, cleanHook, ts.ScriptTarget.Latest, true, ts.ScriptKind.TS);
...
fs.writeFileSync(OUT, cleanHook);
