...
requireText(rules, 'allow list: if canAccessWorkspace(workspaceId);', 'Rules não autorizam listagem tenant-safe de settings para o diagnóstico.');
requireText(fixture, 'Setor lista somente locks NS do próprio workspace para diagnóstico', 'Emulator não prova listagem de locks no próprio workspace.');
requireText(fixture, 'Setor não lista settings de outro workspace', 'Emulator não prova bloqueio de listagem cross-tenant.');
