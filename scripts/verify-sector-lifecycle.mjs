...
requireText(operational, 'startWorkspaceSessionCoordinator', 'Sessão operacional deixou de iniciar o coordenador de ciclo de vida.');
requireText(coordinator, "data.status !== 'active'", 'Watcher coordenado não encerra setor suspenso.');
requireText(coordinator, 'data.firebaseUid !== uid', 'Watcher coordenado não preserva vínculo de UID.');
...
requireText(coordinator, "(data.ug || null) !== context.ug", 'Watcher coordenado não observa divergência da UG organizacional.');
